...
@section('body_content')
    <section class="px-6 md:px-20 my-20">
        <form action="" method="POST" class="md:w-1/4 mx-auto">
            ...
            @if ($errors->any())
                <div class="bg-rose-50 text-rose-500 border border-rose-500 rounded px-2 py-1">
                    <ul>
            ...
            <button class="text-center bg-rose-600 rounded py-1 px-2 w-full mt-8 text-white font-medium">
                Update Password
            </button>
