                        ...
                        <tbody class="bg-gray-700 divide-y divide-gray-600">
                            @foreach ($data as $item)
                                <tr>
                                    ...
                                    <td class="pl-3 py-3">
                                        <div class="text-sm text-gray-200">
                                            {{ $item->till_valid? $item->till_valid->format('d-m-Y h:i A') : '' }}</div>
                                    </td>
            ...
            <form action="{{ route('dpanel.coupon.store') }}" method="post">
                ...
                <div class="grid grid-cols-1 gap-3">
                    ...
                    <div>
                        ...
                        <select name="type" class="w-full bg-transparent border border-gray-500 rounded py-0.5 px-2 focus:outline-none">
        ...
        <div class="flex justify-center items-center min-h-[30vh] md:min-h-[50vh]">
            <form id="edit-form" action="" method="post">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-3">
                    ...
                    <div>
                        <label>Coupon Type<span class="text-red-500 font-bold">*</span></label>
                        <select name="type" id="type" class="w-full bg-transparent border border-gray-500 rounded py-0.5 px-2 focus:outline-none">
                            <option value="">Select Type</option>
                            <option value="Fixed">Fixed</option>
                            <option value="Percentage">Percentage</option>
                        </select>
