                        ...
                        <tbody class="bg-gray-700 divide-y divide-gray-600">
                            @foreach ($data as $item)
                                <tr>
                                    ...
                                    <td class="pl-3 py-3">
                                        <div class="text-sm text-gray-200">
                                            ₱{{ $item->total_amount - $item->discount_amount }}</div>
                                    </td>
                                    ...
                                    <td class="px-4 py-3 justify-center gap-2 text-lg">
                                        <select onchange="updateStatus(this, '{{ $item->id }}')" class="bg-white border rounded focus:outline-none">
                                            <option value="PENDING" @selected($item -> status == 'PENDING')>PENDING</option>
                                            <option value="PAID OUT" @selected($item -> status == 'PAID OU')>PAID OUT</option>
