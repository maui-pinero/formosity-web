...
<body class="w-full flex flex-no-wrap bg-gray-100">
    ...
    <x-dpanel::sidebar.container name="DD Admin">
        ...
        <x-dpanel::sidebar.item name="Dashboard" icon="bx-home" url="{{ route('dpanel.dashboard') }}"
            isActive="{{ request()->segment(2) == 'dashboard' }}" />

            <x-dpanel::sidebar.item name="Banners" icon="bx-bookmark" url="{{ route('dpanel.banner.index') }}"
        ...
        <x-dpanel::sidebar.item name="Coupons" icon="bx bxs-discount" url="{{ route('dpanel.coupon.index') }}"
            isActive="{{ request()->segment(2) == 'coupon' }}" />

        <x-dpanel::sidebar.item name="Orders" icon="bx bx-cart" url="{{ route('dpanel.order.index') }}"
