...
@section('body_content')
    <div class="bg-gray-800 flex justify-between items-center rounded-l-md pl-2 mb-3">
        <p class="text-white font-medium text-lg">Banners</p>
        <button onclick="showBottomSheet('bottomSheet')" class="bg-violet-500 py-1 px-2 rounded-r-md">Create</button>
    </div>
                        ...
                        <tbody class="bg-gray-700 divide-y divide-gray-600">
                            @foreach ($data as $item)
                                <tr>
                                    ...
                                    <td class="px-4 py-3 justify-center text-lg">
                                        <button
                                            onclick="editBanner('{{ $item->id }}', '{{ $item->name }}', '{{ $item->link }}', '{{ $item->is_active }}')"
    ...
    <x-dpanel::modal.bottom-sheet sheetId="bottomSheet" title="New Banner">
            ...
            <form action="{{ route('dpanel.banner.store') }}" method="post" enctype="multipart/form-data">
                ...
                <div class="grid grid-cols-1 gap-3">
                    ...
                    <div class="text-center ">
                        <button class="bg-rose-600 text-center text-white py-1 px-2 rounded shadow-md uppercase">
                            Create
                        </button>
                    </div>
                </div>
    ...
    <x-dpanel::modal.bottom-sheet sheetId="bottomSheetUpdate" title="Update Banner">
        <div class="flex justify-center items-center min-h-[30vh] md:min-h-[50vh]">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-3">
                    ...
                    <div>
                        ...
                        <select name="is_active" id="status"
                            class="w-full bg-white border border-gray-500 rounded py-0.5 px-2 focus:outline-none">
                    ...
                    <div>
                        <label>&nbsp;</label>
                        <button class="w-full bg-rose-600 text-center text-white py-1 px-2 rounded shadow-md uppercase">
                            Update Banner
                        </button>
                    </div>
                </div>
